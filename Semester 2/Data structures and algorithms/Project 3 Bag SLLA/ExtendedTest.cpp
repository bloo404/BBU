...
void testQuantity() {
    ...
    cout << "<- Might take a while or a for (30 000 elements)->" << endl;
    Bag b;
    for (int i = 10; i >= 1; i--) {
    ...
    cout << "<< Quantity: Before assertions, it will take a while (175 739 + 30 0000 * 2 other steps ) >>" << endl;
    ...
    it.first();
    cout << "<< Quantity: Before while, it will take a while 30 000 other steps >>" << endl;
    while (it.valid()) {
    ...
    cout << "<< Quantity: After while, it will take another while (jkjk it s a for, but it still takes a while) 40 000 other steps >>" << endl;
    assert(it.valid() == false);
    for (int i = 0; i < 10; i++) {

...
from .views import BotanicalGardenList, BotanicalGardenDetail, PlantList, PlantDetail, WorkerList, WorkerDetail, WatchingList, WatchingDetail, WorkersByAvgHydrationLevel, BotanicalGardensByAvgPlantAge

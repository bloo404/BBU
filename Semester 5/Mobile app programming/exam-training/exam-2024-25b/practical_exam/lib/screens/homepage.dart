...
import 'package:practical_exam/screens/top_section.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            _buildSectionButton('Progress section', () {
              if (online) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            _buildSectionButton('Top section', () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => TopSection(online: online)),
              );
            }),

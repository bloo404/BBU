...
class _MainSectionState extends State<MainSection> {
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            // ne scarpinam la urechea stanga cu mana dreapta
                            Future<Entity> entity = api.getEntityById(
                                entities[index]); // useless honestly
                            retrieveEntity(entities[index]);
                          },
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(18.0),
  ...
  void retrieveEntity(Entity entity) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ViewEntity(entity: entity),
      ),
    );
  }
}

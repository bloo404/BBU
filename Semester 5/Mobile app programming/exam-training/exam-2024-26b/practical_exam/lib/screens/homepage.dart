...
import 'package:practical_exam/screens/analytics.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            _buildSectionButton('Organizer section', () {
              Navigator.push(
                context,
                MaterialPageRoute(
            ...
            _buildSectionButton('Participant section', () {
              if (online) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            _buildSectionButton('Analytics section', () {
              //TODO this
              if (online) {
                Navigator.push(
                  context,

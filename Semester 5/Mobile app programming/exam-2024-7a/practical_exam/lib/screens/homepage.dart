...
import 'package:practical_exam/screens/teacher.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('School Activity Management App'),
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            _buildSectionButton('Activity organizer section', () {
              Navigator.push(
                context,
                MaterialPageRoute(
            ...
            _buildSectionButton('Student section', () {
              if (online) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            _buildSectionButton('Teacher section', () {
              if (online) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
